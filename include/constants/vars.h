...
#define VAR_KIRBYS_HOUSE_STATE                           0x404E // Kirby's House - Keep track of progress state
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_GREEN_REST_AREA_STATE                        0x4052 // Green Rest Area - Keep track of progress state
#define VAR_LAVARIDGE_TOWN_STATE                         0x4053
#define VAR_CURRENT_SECRET_BASE                          0x4054 // was probably allocated for VAR_FALLARBOR_TOWN_STATE at one point
#define VAR_WADDLE_DEE_TOWN_STATE                        0x4055 // Waddle Dee Town - Keep track of progress state
#define VAR_VEGETABLE_VALLEY_STATE                       0x4056 // Vegetable Valley - Keep track of progress state
...
#define VAR_ARENA_HEALS                                  0x4083 // Various Arenas - used to track number of heals left
...
#define VAR_ARENA_BATTLES                                0x408B // Various Arenas - used to track number of battles completed
