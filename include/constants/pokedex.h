...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_CHAMELEO_ARM,
    NATIONAL_DEX_NODDY,
    NATIONAL_DEX_NRUFF,
    NATIONAL_DEX_NRUFF_AND_NELLY,
    NATIONAL_DEX_BUFFAHORN,
    NATIONAL_DEX_ROLLOZER,
    NATIONAL_DEX_SILLYDILLO,
    NATIONAL_DEX_TORTORNER,
    NATIONAL_DEX_TORTUILDING,
    NATIONAL_DEX_BALLOON_MEISTER,
    NATIONAL_DEX_GABON,
    NATIONAL_DEX_CAPTAIN_STITCH,
    NATIONAL_DEX_HALTWORKER,
    NATIONAL_DEX_MECHAMECH,
    NATIONAL_DEX_INVADER_ARMOR,
    NATIONAL_DEX_BROBO,
    NATIONAL_DEX_JAMBELIEVER,
    NATIONAL_DEX_JAMMERJAB,
    NATIONAL_DEX_BOOLER,
    NATIONAL_DEX_NOO,
    NATIONAL_DEX_SKULLY,
    NATIONAL_DEX_SKULLION,
    NATIONAL_DEX_NECRODEUS,
    NATIONAL_DEX_DUPA,
    NATIONAL_DEX_DIPPA,
    NATIONAL_DEX_DEPPA,
    NATIONAL_DEX_SPHERE_DOOMER,
    NATIONAL_DEX_PHANTA,
    NATIONAL_DEX_ACE_PHANTA,
    NATIONAL_DEX_CAPER,
    NATIONAL_DEX_TEDHAUN,
    NATIONAL_DEX_PRANK,
    NATIONAL_DEX_ESCARDROID,
    NATIONAL_DEX_MAIMAIGON,
    NATIONAL_DEX_CHIBI_DEDEDE,
    NATIONAL_DEX_DEDEDE_ROBO,
    NATIONAL_DEX_GEMAINE,
    NATIONAL_DEX_GALACTAL,
    NATIONAL_DEX_WHISPY_WOODS,
    NATIONAL_DEX_LOLOLO_LALALA,
    NATIONAL_DEX_KABULA,
    NATIONAL_DEX_KRACKO,
    NATIONAL_DEX_ACTI_BLADE,
    NATIONAL_DEX_DYNA_BLADE,
    NATIONAL_DEX_DRAGOON,
    NATIONAL_DEX_HYDRA,
    NATIONAL_DEX_LANDIA,
    NATIONAL_DEX_DARK_MATTER,
    NATIONAL_DEX_NIGHTMARE,
    NATIONAL_DEX_BATAMON,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_DREAM_TEAM_POKEMON == TRUE
...
enum HoennDexOrder
{
    ...
    HOENN_DEX_APOLO,
    HOENN_DEX_BLOPPER,
    HOENN_DEX_CHAMELEO_ARM,
    HOENN_DEX_NODDY,
    HOENN_DEX_NRUFF,
    HOENN_DEX_NRUFF_AND_NELLY,
    HOENN_DEX_BUFFAHORN,
    HOENN_DEX_ROLLOZER,
    HOENN_DEX_SILLYDILLO,
    HOENN_DEX_TORTORNER,
    HOENN_DEX_TORTUILDING,
    HOENN_DEX_BALLOON_MEISTER,
    HOENN_DEX_GABON,
    HOENN_DEX_CAPTAIN_STITCH,
    HOENN_DEX_HALTWORKER,
    HOENN_DEX_MECHAMECH,
    HOENN_DEX_INVADER_ARMOR,
    HOENN_DEX_BROBO,
    HOENN_DEX_JAMBELIEVER,
    HOENN_DEX_JAMMERJAB,
    HOENN_DEX_BOOLER,
    HOENN_DEX_NOO,
    HOENN_DEX_SKULLY,
    ...
    HOENN_DEX_DIPPA,
    HOENN_DEX_DEPPA,
    HOENN_DEX_SPHERE_DOOMER,
    HOENN_DEX_PHANTA,
    HOENN_DEX_ACE_PHANTA,
    HOENN_DEX_CAPER,
    HOENN_DEX_TEDHAUN,
    HOENN_DEX_PRANK,
    HOENN_DEX_ESCARDROID,
    HOENN_DEX_MAIMAIGON,
    HOENN_DEX_CHIBI_DEDEDE,
    HOENN_DEX_DEDEDE_ROBO,
    HOENN_DEX_GEMAINE,
    HOENN_DEX_GALACTAL,
    HOENN_DEX_WHISPY_WOODS,
    HOENN_DEX_LOLOLO_LALALA,
    HOENN_DEX_KABULA,
    HOENN_DEX_KRACKO,
    HOENN_DEX_ACTI_BLADE,
    HOENN_DEX_DYNA_BLADE,
    HOENN_DEX_DRAGOON,
    HOENN_DEX_HYDRA,
    HOENN_DEX_LANDIA,
    HOENN_DEX_DARK_MATTER,
    HOENN_DEX_NIGHTMARE,
    HOENN_DEX_BATAMON,
};
