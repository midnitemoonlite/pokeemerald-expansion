...
static const u8 sText_PlayerScurriedToCenter[] = _("Kirby scurried to a rest area,\nprotecting the exhausted and fainted\nHelpers from further harm…\p");
static const u8 sText_PlayerScurriedBackHome[] = _("Kirby scurried back home, protecting\nthe exhausted and fainted Helpers from\nfurther harm…\p");
static const u8 sText_PlayerRegroupCenter[] = _("Kirby scurried to a rest area,\nto regroup and reconsider the battle\nstrategy…\p");
static const u8 sText_PlayerRegroupHome[] = _("Kirby scurried back home, to regroup\nand reconsider the battle strategy…\p");
