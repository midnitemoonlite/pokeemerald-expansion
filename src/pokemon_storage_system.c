...
static const u8 gText_JustOnePkmn[] = _("There is just one Helper with you.");
...
static const struct StorageMessage sMessages[] =
{
    ...
    [MSG_RELEASE_POKE]         = {COMPOUND_STRING("Release this Helper?"),      MSG_VAR_NONE},
    ...
    [MSG_MARK_POKE]            = {COMPOUND_STRING("Mark your Helper."),         MSG_VAR_NONE},
    [MSG_LAST_POKE]            = {COMPOUND_STRING("That's your last Helper!"),  MSG_VAR_NONE},
    [MSG_PARTY_FULL]           = {gText_YourPartysFull,                          MSG_VAR_NONE},
    [MSG_HOLDING_POKE]         = {COMPOUND_STRING("You're holding a Helper!"),  MSG_VAR_NONE},
    ...
    [MSG_GIVE_TO_MON]          = {COMPOUND_STRING("Give to a Helper?"),         MSG_VAR_NONE},
    [MSG_PLACED_IN_BAG]        = {COMPOUND_STRING("Placed item in the BINDLE."),    MSG_VAR_ITEM_NAME},
    [MSG_BAG_FULL]             = {COMPOUND_STRING("The BINDLE is full."),           MSG_VAR_NONE},
    [MSG_PUT_IN_BAG]           = {COMPOUND_STRING("Put this item in the BINDLE?"),  MSG_VAR_NONE},
