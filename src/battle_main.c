...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("LUMBERJACK"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("SOLDIER"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("DELIVERY"), 8 },
    [TRAINER_CLASS_COLLECTOR] = { _("WISE"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("RAFT"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA") },
    [TRAINER_CLASS_EXPERT] = { _("SMITH"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("WORKER"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("ASTRONOMER"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("FLUFF"), 10 },
    ...
    [TRAINER_CLASS_POKEFAN] = { _("MANAGER"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("FOLLOWER"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] = { _("FISHING"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("CART"), 10 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("BLOCK"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("PARASOL"), 10 },
    ...
    [TRAINER_CLASS_RIVAL] = { _("BANDANA"), 15 },
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = { _("GRAND LEADER"), 25, BALL_ULTRA },
