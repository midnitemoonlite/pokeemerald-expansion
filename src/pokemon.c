...
{
    HOENN_TO_NATIONAL(LOVELY),
    HOENN_TO_NATIONAL(ROSELY),
    HOENN_TO_NATIONAL(SECTONIA_VINE),
    HOENN_TO_NATIONAL(BURNING_LEO),
    HOENN_TO_NATIONAL(ACCHI),
    HOENN_TO_NATIONAL(PYRIBBIT),
    HOENN_TO_NATIONAL(SQUISHY),
    HOENN_TO_NATIONAL(SQUISTER),
    HOENN_TO_NATIONAL(CLAYKKEN),
    HOENN_TO_NATIONAL(CHIP),
    HOENN_TO_NATIONAL(CHIPPURUS),
    HOENN_TO_NATIONAL(BRONTO_BURT),
    HOENN_TO_NATIONAL(HALCANTO_BURT),
    ...
    HOENN_TO_NATIONAL(WADDLE_DOO),
    HOENN_TO_NATIONAL(KING_DOO),
    HOENN_TO_NATIONAL(BEANBON),
    HOENN_TO_NATIONAL(BIG_BEANBON),
    HOENN_TO_NATIONAL(BIGGER_BEANBON),
    HOENN_TO_NATIONAL(BIG_MUMMBON),
    HOENN_TO_NATIONAL(BIG_ZOMBON),
    HOENN_TO_NATIONAL(GAW_GAW),
    HOENN_TO_NATIONAL(GAO_GAO),
    HOENN_TO_NATIONAL(CAPPY),
    HOENN_TO_NATIONAL(POISON_MASH),
    HOENN_TO_NATIONAL(POPPY_BROS_JR),
    HOENN_TO_NATIONAL(POPPY_BROS_SR),
    HOENN_TO_NATIONAL(UFO),
    HOENN_TO_NATIONAL(BLADE_KNIGHT),
    HOENN_TO_NATIONAL(GIGANT_EDGE),
    HOENN_TO_NATIONAL(IGNITE_EDGE),
    HOENN_TO_NATIONAL(SIR_KIBBLE),
    HOENN_TO_NATIONAL(KIBBLE_BLADE),
    HOENN_TO_NATIONAL(FROST_KIBBLE_BLADE),
    HOENN_TO_NATIONAL(NEEDLOUS),
    HOENN_TO_NATIONAL(PUNC),
    HOENN_TO_NATIONAL(PIERCE),
    HOENN_TO_NATIONAL(BROOM_HATTER),
    HOENN_TO_NATIONAL(KEKE),
    HOENN_TO_NATIONAL(GRYLL),
    HOENN_TO_NATIONAL(AWOOFY),
    HOENN_TO_NATIONAL(PRIMAL_AWOOFY),
    HOENN_TO_NATIONAL(KABU),
    HOENN_TO_NATIONAL(BIG_KABU),
    HOENN_TO_NATIONAL(BLIPPER),
    HOENN_TO_NATIONAL(MAMATEE),
    HOENN_TO_NATIONAL(BLING_BLIPPER),
    HOENN_TO_NATIONAL(LEAFAN),
    HOENN_TO_NATIONAL(BULBY),
    HOENN_TO_NATIONAL(BEETLEY),
    HOENN_TO_NATIONAL(HORNHEAD),
    HOENN_TO_NATIONAL(BUGZZY),
    HOENN_TO_NATIONAL(MR_ANGLEP),
    HOENN_TO_NATIONAL(MR_P_UMPKIN),
    HOENN_TO_NATIONAL(SULKWORM),
    HOENN_TO_NATIONAL(FANGORA),
    HOENN_TO_NATIONAL(BUTTONFLY),
    HOENN_TO_NATIONAL(ORBITFLY),
    HOENN_TO_NATIONAL(MAIGA),
    HOENN_TO_NATIONAL(POPON),
    HOENN_TO_NATIONAL(CONER),
    HOENN_TO_NATIONAL(DRIFTER),
    HOENN_TO_NATIONAL(JUMPER_SHOOT),
    HOENN_TO_NATIONAL(PIERRE),
    HOENN_TO_NATIONAL(CLOWN_ACROBOT),
    HOENN_TO_NATIONAL(SPARKY),
    HOENN_TO_NATIONAL(MASTER_GREEN),
    HOENN_TO_NATIONAL(MR_FLOATY),
    HOENN_TO_NATIONAL(MR_FROSTY),
    HOENN_TO_NATIONAL(FLOTZO),
    HOENN_TO_NATIONAL(FLOTZO_BORG),
    HOENN_TO_NATIONAL(GIANT_FLOTZO),
    HOENN_TO_NATIONAL(ROCKY),
    HOENN_TO_NATIONAL(GIANT_ROCKY),
    HOENN_TO_NATIONAL(MOUNDO),
    HOENN_TO_NATIONAL(BATTY),
    HOENN_TO_NATIONAL(PRICKLEBAT),
    HOENN_TO_NATIONAL(BUZZYBAT),
    HOENN_TO_NATIONAL(FLAMER),
    HOENN_TO_NATIONAL(CHAIN_FLAMER),
    HOENN_TO_NATIONAL(BOXIN),
    HOENN_TO_NATIONAL(BUN),
    HOENN_TO_NATIONAL(BOX_BOXER),
    HOENN_TO_NATIONAL(EMBA),
    HOENN_TO_NATIONAL(CANDLEMANDER),
    HOENN_TO_NATIONAL(EMBACONDA),
    HOENN_TO_NATIONAL(EMBIRD),
    HOENN_TO_NATIONAL(HOT_WINGS),
    HOENN_TO_NATIONAL(GUARD),
    HOENN_TO_NATIONAL(SOLITE),
    HOENN_TO_NATIONAL(TRANSFORMER),
    HOENN_TO_NATIONAL(FOLEY),
    HOENN_TO_NATIONAL(JUNGLE_BOMB),
    HOENN_TO_NATIONAL(COBGOBLIN),
    HOENN_TO_NATIONAL(PHAN_PHAN),
    HOENN_TO_NATIONAL(FRIDGY),
    HOENN_TO_NATIONAL(KACTI),
    HOENN_TO_NATIONAL(STACTUS),
    HOENN_TO_NATIONAL(CRAZY_STACTUS),
    HOENN_TO_NATIONAL(GATOR),
    HOENN_TO_NATIONAL(GNAWCODILE),
    HOENN_TO_NATIONAL(GLUNK),
    HOENN_TO_NATIONAL(DEEPSEE),
    HOENN_TO_NATIONAL(SLIPPY),
    HOENN_TO_NATIONAL(SIR_SLIPPY),
    HOENN_TO_NATIONAL(CRABY),
    HOENN_TO_NATIONAL(CAPSULE_J),
    HOENN_TO_NATIONAL(CAPSULE_J2),
    HOENN_TO_NATIONAL(CAPSULE_J3),
    HOENN_TO_NATIONAL(LASER_BALL),
    HOENN_TO_NATIONAL(PLASMA_WISP),
    HOENN_TO_NATIONAL(SODORY),
    HOENN_TO_NATIONAL(HELMEE),
    HOENN_TO_NATIONAL(GHOST_KNIGHT),
    HOENN_TO_NATIONAL(BANG_BANG),
    HOENN_TO_NATIONAL(BIG_MISSILE),
    HOENN_TO_NATIONAL(MINI_MASHER),
    HOENN_TO_NATIONAL(MASHER),
    HOENN_TO_NATIONAL(MEGA_MASHER),
    HOENN_TO_NATIONAL(WHEELIE),
    HOENN_TO_NATIONAL(DIGGUH),
    HOENN_TO_NATIONAL(MOGMOLE),
    HOENN_TO_NATIONAL(MOLEY),
    HOENN_TO_NATIONAL(KAPAR),
    HOENN_TO_NATIONAL(KNUCKLE_JOE),
    HOENN_TO_NATIONAL(SANDRAN),
    HOENN_TO_NATIONAL(WALF),
    HOENN_TO_NATIONAL(CAWCUN),
    HOENN_TO_NATIONAL(FLEURINA),
    HOENN_TO_NATIONAL(ACRO),
    HOENN_TO_NATIONAL(FATTY_WHALE),
    HOENN_TO_NATIONAL(MOOKIE),
    HOENN_TO_NATIONAL(BONKERS),
    HOENN_TO_NATIONAL(WILD_BONKERS),
    HOENN_TO_NATIONAL(SPARK_BONKERS),
    HOENN_TO_NATIONAL(WHIPPY),
    HOENN_TO_NATIONAL(FIRE_LION),
    HOENN_TO_NATIONAL(WALKY),
    HOENN_TO_NATIONAL(TICK_TOCK_JR),
    HOENN_TO_NATIONAL(MR_TICK_TOCK),
    HOENN_TO_NATIONAL(COOKIN),
    HOENN_TO_NATIONAL(CHEF_KAWASAKI),
    HOENN_TO_NATIONAL(MOONJA),
    HOENN_TO_NATIONAL(BIO_SPARK),
    HOENN_TO_NATIONAL(WAIU),
    HOENN_TO_NATIONAL(BOMBER),
    HOENN_TO_NATIONAL(BALLOON_BOMBER),
    HOENN_TO_NATIONAL(SCARFY),
    HOENN_TO_NATIONAL(SNOOTER),
    HOENN_TO_NATIONAL(IRON_MAM),
    HOENN_TO_NATIONAL(GRAND_MAM),
    HOENN_TO_NATIONAL(BLOCKIN),
    HOENN_TO_NATIONAL(OWGULF),
    HOENN_TO_NATIONAL(BOHBOH),
    HOENN_TO_NATIONAL(TOOTLEBAM),
    HOENN_TO_NATIONAL(FLOATY_THE_CELL_CORE),
    HOENN_TO_NATIONAL(BUBOO),
    HOENN_TO_NATIONAL(GUSSA),
    HOENN_TO_NATIONAL(JOE),
    HOENN_TO_NATIONAL(GOBBLER),
    HOENN_TO_NATIONAL(MOPOO),
    HOENN_TO_NATIONAL(CHILLY),
    HOENN_TO_NATIONAL(SNOWMAN),
    HOENN_TO_NATIONAL(FRIGIS),
    HOENN_TO_NATIONAL(SNOWL),
    ...
    HOENN_TO_NATIONAL(SLUSHY),
    HOENN_TO_NATIONAL(SQUIBBY),
    HOENN_TO_NATIONAL(COMO),
    HOENN_TO_NATIONAL(SPIDEROO),
    HOENN_TO_NATIONAL(GRIZZO),
    HOENN_TO_NATIONAL(PEPERON),
    HOENN_TO_NATIONAL(OOHROO),
    HOENN_TO_NATIONAL(GORIATH),
    HOENN_TO_NATIONAL(NESP),
    HOENN_TO_NATIONAL(MADOO),
    HOENN_TO_NATIONAL(VENOGG),
    HOENN_TO_NATIONAL(POISON_CROAKOM),
    HOENN_TO_NATIONAL(BOUNCY),
    HOENN_TO_NATIONAL(BOUNCY_SIS),
    HOENN_TO_NATIONAL(FISHBONE),
    HOENN_TO_NATIONAL(BLISH),
    HOENN_TO_NATIONAL(GALBO),
    HOENN_TO_NATIONAL(WATER_GALBOROS),
    HOENN_TO_NATIONAL(FLAME_GALBOROS),
    HOENN_TO_NATIONAL(MIASMOROS),
    HOENN_TO_NATIONAL(KEY_DEE),
    HOENN_TO_NATIONAL(SLIME),
    HOENN_TO_NATIONAL(PUPPET),
    HOENN_TO_NATIONAL(MAGICIAN),
    HOENN_TO_NATIONAL(TOREROBO),
    HOENN_TO_NATIONAL(ROBO_RICK),
    HOENN_TO_NATIONAL(BOXY),
    HOENN_TO_NATIONAL(HANDS),
    HOENN_TO_NATIONAL(GOLEM_KIRBY),
    HOENN_TO_NATIONAL(KING_GOLEM),
    HOENN_TO_NATIONAL(SNOOZROOT),
    HOENN_TO_NATIONAL(LADY_IVY),
    HOENN_TO_NATIONAL(SNIPPER),
    HOENN_TO_NATIONAL(ANT_DOOM),
    HOENN_TO_NATIONAL(METALUN),
    HOENN_TO_NATIONAL(BIG_METALUN),
    HOENN_TO_NATIONAL(HB_002),
    HOENN_TO_NATIONAL(HB_007),
    HOENN_TO_NATIONAL(CUTFISH),
    HOENN_TO_NATIONAL(SAWGILL),
    HOENN_TO_NATIONAL(ANGIE),
    HOENN_TO_NATIONAL(CUPIE),
    HOENN_TO_NATIONAL(ANGEL),
    HOENN_TO_NATIONAL(SIMIRROR),
    HOENN_TO_NATIONAL(TWISTER),
    HOENN_TO_NATIONAL(WINDWHIPPER),
    HOENN_TO_NATIONAL(DUBIOR_JR),
    HOENN_TO_NATIONAL(DUBIOR),
    HOENN_TO_NATIONAL(COOL_SPOOK),
    HOENN_TO_NATIONAL(TAC),
    HOENN_TO_NATIONAL(CHEMITORY),
    HOENN_TO_NATIONAL(COTTA),
    HOENN_TO_NATIONAL(CANNON_COTTA),
    HOENN_TO_NATIONAL(BASTRON),
    HOENN_TO_NATIONAL(PARA_SORCERESS),
    HOENN_TO_NATIONAL(VIVIDRIA),
    HOENN_TO_NATIONAL(MIKARIN),
    HOENN_TO_NATIONAL(KAGAMI_MOCCHI),
    HOENN_TO_NATIONAL(BLOON),
    HOENN_TO_NATIONAL(STARMAN),
    HOENN_TO_NATIONAL(RINGLE),
    HOENN_TO_NATIONAL(I3),
    HOENN_TO_NATIONAL(ORBSERVOR),
    HOENN_TO_NATIONAL(SPYNUM),
    HOENN_TO_NATIONAL(SECTRA_SHOOTER),
    HOENN_TO_NATIONAL(PACTO),
    HOENN_TO_NATIONAL(MIRRA),
    HOENN_TO_NATIONAL(MR_SHINE),
    HOENN_TO_NATIONAL(MR_BRIGHT),
    HOENN_TO_NATIONAL(PLUGG),
    HOENN_TO_NATIONAL(META_KNIGHTS),
    HOENN_TO_NATIONAL(MINNY),
    HOENN_TO_NATIONAL(MOGGY),
    HOENN_TO_NATIONAL(APOLO),
    HOENN_TO_NATIONAL(BLOPPER),
    HOENN_TO_NATIONAL(CHAMELEO_ARM),
    HOENN_TO_NATIONAL(NODDY),
    HOENN_TO_NATIONAL(NRUFF),
    HOENN_TO_NATIONAL(NRUFF_AND_NELLY),
    HOENN_TO_NATIONAL(BUFFAHORN),
    HOENN_TO_NATIONAL(ROLLOZER),
    HOENN_TO_NATIONAL(SILLYDILLO),
    HOENN_TO_NATIONAL(TORTORNER),
    HOENN_TO_NATIONAL(TORTUILDING),
    HOENN_TO_NATIONAL(BALLOON_MEISTER),
    HOENN_TO_NATIONAL(GABON),
    HOENN_TO_NATIONAL(CAPTAIN_STITCH),
    HOENN_TO_NATIONAL(HALTWORKER),
    HOENN_TO_NATIONAL(MECHAMECH),
    HOENN_TO_NATIONAL(INVADER_ARMOR),
    HOENN_TO_NATIONAL(BROBO),
    HOENN_TO_NATIONAL(JAMBELIEVER),
    HOENN_TO_NATIONAL(JAMMERJAB),
    HOENN_TO_NATIONAL(BOOLER),
    HOENN_TO_NATIONAL(NOO),
    HOENN_TO_NATIONAL(SKULLY),
    HOENN_TO_NATIONAL(SKULLION),
    HOENN_TO_NATIONAL(NECRODEUS),
    HOENN_TO_NATIONAL(DUPA),
    HOENN_TO_NATIONAL(DIPPA),
    HOENN_TO_NATIONAL(DEPPA),
    HOENN_TO_NATIONAL(SPHERE_DOOMER),
    HOENN_TO_NATIONAL(PHANTA),
    HOENN_TO_NATIONAL(ACE_PHANTA),
    HOENN_TO_NATIONAL(CAPER),
    HOENN_TO_NATIONAL(TEDHAUN),
    HOENN_TO_NATIONAL(PRANK),
    HOENN_TO_NATIONAL(ESCARDROID),
    HOENN_TO_NATIONAL(MAIMAIGON),
    HOENN_TO_NATIONAL(CHIBI_DEDEDE),
    HOENN_TO_NATIONAL(DEDEDE_ROBO),
    HOENN_TO_NATIONAL(GEMAINE),
    HOENN_TO_NATIONAL(GALACTAL),
    HOENN_TO_NATIONAL(WHISPY_WOODS),
    HOENN_TO_NATIONAL(LOLOLO_LALALA),
    HOENN_TO_NATIONAL(KABULA),
    HOENN_TO_NATIONAL(KRACKO),
    HOENN_TO_NATIONAL(ACTI_BLADE),
    HOENN_TO_NATIONAL(DYNA_BLADE),
    HOENN_TO_NATIONAL(DRAGOON),
    HOENN_TO_NATIONAL(HYDRA),
    HOENN_TO_NATIONAL(LANDIA),
    HOENN_TO_NATIONAL(DARK_MATTER),
    HOENN_TO_NATIONAL(NIGHTMARE),
...
u32 GetFormChangeTargetSpecies_Internal(struct FormChangeContext ctx)
{
    ...
    for (i = 0; formChanges[i].method != FORM_CHANGE_TERMINATOR; i++)
    {
        ...
        case FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE:
            if (formChanges[i].param1 == GetBattleMoveType(gCurrentMove)
                && (formChanges[i].param2 == ABILITY_NONE || formChanges[i].param2 == ctx.ability))
                targetSpecies = formChanges[i].targetSpecies;
            break;
