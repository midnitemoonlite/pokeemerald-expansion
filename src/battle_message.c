...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("You have no more Helpers that can fight!\p"),
    ...
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("The Helper was hit {B_BUFF1} time(s)!"), //SV has dynamic plural here
    ...
    [STRINGID_FAINTINTHREE]                         = COMPOUND_STRING("All Helpers that heard the song will faint in three turns!"),
    ...
    [STRINGID_PLAYERUSEDITEM]                       = COMPOUND_STRING("You used a {B_LAST_ITEM}!"),
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("WALLY used {B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    [STRINGID_TRAINERBLOCKEDBALL]                   = COMPOUND_STRING("The Trainer blocked your Friend Heart!"),
    [STRINGID_DONTBEATHIEF]                         = COMPOUND_STRING("Don't be a thief!"),
    [STRINGID_ITDODGEDBALL]                         = COMPOUND_STRING("It dodged your thrown Friend Heart! This Helper can't be caught!"),
    [STRINGID_PKMNBROKEFREE]                        = COMPOUND_STRING("Oh no! The Helper broke free!"),
    ...
    [STRINGID_PKMNDATAADDEDTODEX]                   = COMPOUND_STRING("{B_DEF_NAME}'s data has been added to the Info Cards!\p"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{B_TRAINER1_NAME_WITH_CLASS} is about to send out {B_BUFF2}.\pWill you switch your Helper?"),
    ...
    [STRINGID_OUTOFSAFARIBALLS]                     = COMPOUND_STRING("{PLAY_SE SE_DING_DONG}ANNOUNCER: You're out of Safari Hearts! Game over!\p"), //safari
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("You throw a Heart now, right? I… I'll do my best!"),
    ...
    [STRINGID_USENEXTPKMN]                          = COMPOUND_STRING("Use next Helper?"),
    ...
    [STRINGID_PKMNLEVITATEDONELECTROMAGNETISM]      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} began levitating!"),
    ...
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("It created a bizarre area in which Helpers' held items lose their effects!"),
    ...
    [STRINGID_ELECTROMAGNETISM]                     = COMPOUND_STRING("levitation"),
    ...
    [STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("When the flame touched the powder on the Helper, it exploded!"),
    ...
    [STRINGID_CELEBRATEMESSAGE]                     = COMPOUND_STRING("Congratulations, Kirby!"),
    ...
    [STRINGID_AURABREAKENTERS]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} reversed all other Helper's auras!"),
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("Both Helpers will perish in three turns!"),  //don't think this message is displayed anymore
    ...
    [STRINGID_MYSTERIOUSAIRCURRENT]                 = COMPOUND_STRING("Mysterious strong winds are protecting Flying-type Helpers!"),
    ...
    [STRINGID_BOTHCANNOLONGERESCAPE]                = COMPOUND_STRING("Neither Helper can run away!"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} weakened the {B_BUFF1} of all surrounding Helpers!\p"),
    ...
    [STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("Sharp-pointed pieces of steel started floating around {B_DEF_TEAM2} Helpers!"),
    ...
    [STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("The pieces of steel surrounding {B_ATK_TEAM2} Helpers disappeared!"),
    [STRINGID_TEAMTRAPPEDWITHVINES]                 = COMPOUND_STRING("{B_DEF_TEAM1} Helpers got trapped with vines!"),
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Vine Lash's ferocious beating!"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_DEF_TEAM1} Helpers got caught in a vortex of water!"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Cannonade's vortex!"),
    [STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{B_DEF_TEAM1} Helpers were surrounded by fire!"),
    [STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is burning up within G-Max Wildfire's flames!"),
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_DEF_TEAM1} Helpers became surrounded by rocks!"),
    ...
    [STRINGID_ZEROTOHEROTRANSFORMATION]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} underwent a monstrous transformation!"),
    ...
    [STRINGID_HOSPITALITYRESTORATION]               = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} drank down all the tea that {B_SCR_NAME_WITH_PREFIX2} made!"),
    ...
    [STRINGID_BIZARREARENACREATED]                  = COMPOUND_STRING("A bizarre area was created in which Helpers' held items lose their effects!"),
    ...
    [STRINGID_COMMANDERACTIVATES]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} hopped on Mecha-Rick and became Mecha-Rick's commander!"),
    ...
    [STRINGID_MONHEARINGFLUTEAWOKE]                 = COMPOUND_STRING("The Helper hearing the flute awoke!"),
    ...
    [STRINGID_POWERCONSTRUCTTRANSFORM]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} transformed into its Split Forme!"),
...
const u8 gText_BattleMenu[] = _("Battle{CLEAR_TO 56}Bag\nHelpers{CLEAR_TO 56}Run");
const u8 gText_SafariZoneMenu[] = _("Heart{CLEAR_TO 56}{POKEBLOCK}\nGo Near{CLEAR_TO 56}Run");
const u8 gText_SafariZoneMenuFrlg[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}HEART{CLEAR_TO 56}BAIT\nROCK{CLEAR_TO 56}RUN");
...
const u8 gText_SafariBalls[] = _("Safari Hearts");
...
const u8 *const gRefereeStringsTable[] =
{
    ...
    [B_MSG_REF_JUDGE_MIND]         = COMPOUND_STRING("REFEREE: Judging category 1, Mind! The Helper showing the most guts!\p"),
    [B_MSG_REF_JUDGE_SKILL]        = COMPOUND_STRING("REFEREE: Judging category 2, Skill! The Helper using moves the best!\p"),
    [B_MSG_REF_JUDGE_BODY]         = COMPOUND_STRING("REFEREE: Judging category 3, Body! The Helper with the most vitality!\p"),
