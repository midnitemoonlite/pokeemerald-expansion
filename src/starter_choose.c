...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_LOVELY)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_BURNING_LEO)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_SQUISHY )
