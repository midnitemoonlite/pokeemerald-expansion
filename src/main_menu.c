...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 122, 66, 0, 0, 32, PALETTES_BG, SPECIES_BRONTO_BURT);
...
{
    return CreateMonPicSprite_Affine(SPECIES_BRONTO_BURT, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
