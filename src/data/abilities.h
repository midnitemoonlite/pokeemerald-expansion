const struct AbilityInfo gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    {
        .name = _("Battle Bond"),
        .description = COMPOUND_STRING("Increases stats after a KO."),
        .aiRating = 6,
        //.cantBeCopied = TRUE,
        //.cantBeSwapped = TRUE,
        //.cantBeTraced = TRUE,
    ...
    {
        .name = _("Hero to Zero"),
        .description = COMPOUND_STRING("Change on switch if strong."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    {
        .name = _("Commander"),
        .description = COMPOUND_STRING("Commands from Mecha-Rick."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    ...
    [ABILITY_AS_ONE_SHINE_BRIGHT] =
    {
        .name = _("As One"),
        .description = COMPOUND_STRING("Misty Surge and Drought."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
