...
{
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_BUTTERFLY_SWARM, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_BUTTERFLY_SOLO,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_SWITCH,     SPECIES_BUTTERFLY_SOLO},
