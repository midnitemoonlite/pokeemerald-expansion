...
static const struct FormChange sButterflyFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_BUTTERFLY_SWARM, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25, 27},
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_BUTTERFLY_SOLO,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_BUTTERFLY_SWARM, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25, 27},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_BUTTERFLY_SOLO,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,          SPECIES_BUTTERFLY_SOLO},
    {FORM_CHANGE_FAINT,                      SPECIES_BUTTERFLY_SOLO},
    {FORM_CHANGE_END_BATTLE,                 SPECIES_BUTTERFLY_SOLO},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sBeanbonFormChangeTable[] =
{
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_PLANT, BATTLE_ENVIRONMENT_GRASS},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_PLANT, BATTLE_ENVIRONMENT_LONG_GRASS},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_PLANT, BATTLE_ENVIRONMENT_POND},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_PLANT, BATTLE_ENVIRONMENT_MOUNTAIN},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_PLANT, BATTLE_ENVIRONMENT_PLAIN},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_SANDY, BATTLE_ENVIRONMENT_CAVE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_SANDY, BATTLE_ENVIRONMENT_SAND},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BEANBON_TRASH, BATTLE_ENVIRONMENT_BUILDING},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sGuardFormChangeTable[] =
{
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_SHIELDLESS,   ITEM_NONE,         ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_NORMAL,       ITEM_BLANK_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_FIRE,         ITEM_FLAME_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_ICE,          ITEM_ICICLE_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_WATER,        ITEM_SPLASH_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_ELECTRIC,     ITEM_ZAP_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_FLYING,       ITEM_SKY_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_PSYCHIC,      ITEM_MIND_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_ROCK,         ITEM_STONE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_FIGHTING,     ITEM_FIST_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_FAIRY,        ITEM_PIXIE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_GRASS,        ITEM_MEADOW_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_GROUND,       ITEM_EARTH_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_POISON,       ITEM_TOXIC_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_STEEL,        ITEM_IRON_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_DARK,         ITEM_DREAD_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_BUG,          ITEM_INSECT_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_GHOST,        ITEM_SPOOKY_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GUARD_DRAGON,       ITEM_DRACO_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sWheelieFormChangeTable[] =
{
    {FORM_CHANGE_ITEM_HOLD, SPECIES_WHEELIE_BIKE,       ITEM_NONE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_WHEELIE_REX,        ITEM_DOUSE_DRIVE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_WHEELIE_SCOOTER,    ITEM_CHILL_DRIVE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_WHEELIE_GRAND,      ITEM_SHOCK_DRIVE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_WHEELIE_BLAZE,      ITEM_BURN_DRIVE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sSnooterFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_TURN_END,   SPECIES_SNOOTER_ANGRY,     ABILITY_HUNGER_SWITCH},
    {FORM_CHANGE_BATTLE_TURN_END,   SPECIES_SNOOTER_NORMAL,    ABILITY_HUNGER_SWITCH},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_BITE},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_BITE},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_CRUNCH},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_CRUNCH},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_HYPER_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_HYPER_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_FIRE_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_FIRE_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_THUNDER_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_THUNDER_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_ICE_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_ICE_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_POISON_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_POISON_FANG},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_PSYCHIC_FANGS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_PSYCHIC_FANGS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_JAW_LOCK},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_JAW_LOCK},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_FISHIOUS_REND},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_FISHIOUS_REND},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_ABSORB},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_ABSORB},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_MEGA_DRAIN},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_MEGA_DRAIN},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_GIGA_DRAIN},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_GIGA_DRAIN},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_SWEET_KISS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_SWEET_KISS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_DRAINING_KISS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_DRAINING_KISS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_LOVELY_KISS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_LOVELY_KISS},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GULPING, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_LICK},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_SNOOTER_GORGING, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_LICK},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,             SPECIES_SNOOTER_NORMAL},
    {FORM_CHANGE_FAINT,                         SPECIES_SNOOTER_NORMAL},
    {FORM_CHANGE_END_BATTLE,                    SPECIES_SNOOTER_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sSnooterGulpMissileFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,   SPECIES_SNOOTER_NORMAL,   ABILITY_GULP_MISSILE, DAMAGE_CATEGORY_PHYSICAL},
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,   SPECIES_SNOOTER_NORMAL,   ABILITY_GULP_MISSILE, DAMAGE_CATEGORY_SPECIAL},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,             SPECIES_SNOOTER_NORMAL},
    {FORM_CHANGE_FAINT,                         SPECIES_SNOOTER_NORMAL},
    {FORM_CHANGE_END_BATTLE,                    SPECIES_SNOOTER_NORMAL},
    {FORM_CHANGE_TERMINATOR},
...
static const struct FormChange sGrandMamFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_GRAND_MAM_ARMORED,     ABILITY_SHIELDS_DOWN, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_GRAND_MAM_UNARMORED,   ABILITY_SHIELDS_DOWN, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_GRAND_MAM_ARMORED,     ABILITY_SHIELDS_DOWN, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_GRAND_MAM_UNARMORED,   ABILITY_SHIELDS_DOWN, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sBukisetNormalFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_FIRE,     TYPE_FIRE,      ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_ICE,      TYPE_ICE,       ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_WATER,    TYPE_WATER,     ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_ELECTRIC, TYPE_ELECTRIC,  ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_FLYING,   TYPE_FLYING,    ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_PSYCHIC,  TYPE_PSYCHIC,   ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_ROCK,     TYPE_ROCK,      ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_FIGHTING, TYPE_FIGHTING,  ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_FAIRY,    TYPE_FAIRY,     ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_GRASS,    TYPE_GRASS,     ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_GROUND,   TYPE_GROUND,    ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_POISON,   TYPE_POISON,    ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_STEEL,    TYPE_STEEL,     ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_DARK,     TYPE_DARK,      ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_BUG,      TYPE_BUG,       ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_GHOST,    TYPE_GHOST,     ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_BUKISET_DRAGON,   TYPE_DRAGON,    ABILITY_PROTEAN},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,       SPECIES_BUKISET_NORMAL},
    {FORM_CHANGE_FAINT,                   SPECIES_BUKISET_NORMAL},
    {FORM_CHANGE_END_BATTLE,              SPECIES_BUKISET_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sBukisetProteanFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_SWITCH_OUT,           SPECIES_BUKISET_NORMAL},
    {FORM_CHANGE_FAINT,                       SPECIES_BUKISET_NORMAL},
    {FORM_CHANGE_END_BATTLE,                  SPECIES_BUKISET_NORMAL},
...
static const struct FormChange sOohrooFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_OOHROO_NORMAL,   ABILITY_ZEN_MODE, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_OOHROO_ZEN,      ABILITY_ZEN_MODE, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,          SPECIES_OOHROO_ZEN,      ABILITY_ZEN_MODE},
    {FORM_CHANGE_FAINT,                      SPECIES_OOHROO_NORMAL},
    {FORM_CHANGE_END_BATTLE,                 SPECIES_OOHROO_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGoriathFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_GORIATH_NORMAL,   ABILITY_ZEN_MODE, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_GORIATH_ZEN,      ABILITY_ZEN_MODE, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,          SPECIES_GORIATH_ZEN,      ABILITY_ZEN_MODE},
    {FORM_CHANGE_FAINT,                      SPECIES_GORIATH_NORMAL},
    {FORM_CHANGE_END_BATTLE,                 SPECIES_GORIATH_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sBlopperFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_WEATHER,                   SPECIES_BLOPPER_ICING,   B_WEATHER_ICY_ANY, ABILITY_ICE_FACE},
    {FORM_CHANGE_BATTLE_HIT_BY_CONFUSION_SELF_DMG, SPECIES_BLOPPER_ICELESS, ABILITY_ICE_FACE},
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,      SPECIES_BLOPPER_ICELESS, ABILITY_ICE_FACE, DAMAGE_CATEGORY_PHYSICAL},
    {FORM_CHANGE_FAINT,                            SPECIES_BLOPPER_ICING},
    {FORM_CHANGE_END_BATTLE,                       SPECIES_BLOPPER_ICING},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGabonFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_HIT_BY_CONFUSION_SELF_DMG, SPECIES_GABON_BUSTED,   ABILITY_DISGUISE},
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,      SPECIES_GABON_BUSTED,   ABILITY_DISGUISE, DAMAGE_CATEGORY_PHYSICAL},
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,      SPECIES_GABON_BUSTED,   ABILITY_DISGUISE, DAMAGE_CATEGORY_SPECIAL},
    {FORM_CHANGE_FAINT,                            SPECIES_GABON_DISGUISED},
    {FORM_CHANGE_END_BATTLE,                       SPECIES_GABON_DISGUISED},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sSphereDoomerFormChangeTable[] =
{
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SPHERE_DOOMER_SUN, B_WEATHER_SUN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SPHERE_DOOMER_RAIN, B_WEATHER_RAIN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SPHERE_DOOMER_SNOW, B_WEATHER_ICY_ANY, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SPHERE_DOOMER_NORMAL, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_ICY_ANY), ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SPHERE_DOOMER_NORMAL, B_WEATHER_NONE, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_SWITCH_OUT, SPECIES_SPHERE_DOOMER_NORMAL},
    {FORM_CHANGE_FAINT,             SPECIES_SPHERE_DOOMER_NORMAL},
    {FORM_CHANGE_END_BATTLE,        SPECIES_SPHERE_DOOMER_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};
