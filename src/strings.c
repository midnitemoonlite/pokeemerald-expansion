...
const u8 gText_OddEggFoundByCouple[] = _("An odd HELPER EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar HELPER EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar HELPER EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A HELPER EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd HELPER EGG\nobtained from a traveler.");
...
const u8 gText_PokemonCenter[] = _("REST AREA");
