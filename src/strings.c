...
const u8 gText_Pokemon[POKEMON_NAME_LENGTH + 1] = _("Helper");
const u8 gText_Player[] = _("PLAYER"); // Unused
const u8 gText_Pokedex[] = _("CARDS"); // Unused
const u8 gText_Time[] = _("TIME");
const u8 gText_Badges[] = _("BROOCHES"); // Unused
...
const u8 gText_ThisIsAPokemon[] = _("…not the least of which are the curious\nallies we call “Helpers”. Like this! {PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? Helper");
...
const u8 gText_EmptyPkmnCategory[] = _("                       Helper"); // Unused
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching Helpers were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for Helpers based on\nselected parameters.");
const u8 gText_SwitchPokedexListings[] = _("Switch Info Card listings.");
const u8 gText_ReturnToPokedex[] = _("Return to Info Cards.");
const u8 gText_SelectPokedexMode[] = _("Select Info Card mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select Info Card listing mode.");
const u8 gText_ListByFirstLetter[] = _("List by the first letter in the name.\nSpotted Helpers only.");
...
const u8 gText_DexHoennTitle[] = _("DREAM LAND");
const u8 gText_DexNatTitle[] = _("POPSTAR");
...
const u8 gText_DexHoennDescription[] = _("Dream Land's Helpers");
const u8 gText_DexNatDescription[] = _("Popstar's Helpers");
const u8 gText_DexSortNumericalDescription[] = _("Helpers are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned Helpers are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned Helpers are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned Helpers are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned Helpers are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned Helpers are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted Helpers: {STR_VAR_1}!\nOwned Helpers: {STR_VAR_2}!\pWise Waddle Dee's POKéDEX rating!\pWise Waddle Dee: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Choose a Helper!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this Helper?");
const u8 gText_Pokemon4[] = _("Helper"); // Unused
...
const u8 gText_CloseBag[] = _("CLOSE BINDLE");
...
const u8 gText_DadsAdvice[] = _("DAD's advice…\nKirby, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayerUsedVar2[] = _("Kirby used the\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the Helper list");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_POKE_BALLS] =   COMPOUND_STRING("HEARTS"),
...
const u8 gText_InBagVar1[] = _("IN BINDLE: {STR_VAR_1}");
...
const u8 gText_NextFusionMon[] = _("Choose what to fuse with.");
const u8 gText_CantBeUsedOnPkmn[] = _("This can't be used on\nthat Helper.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} Helpers\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which Helper?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a Helper.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which Helper?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which Helper?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which Helper?");
const u8 gText_DoWhatWithPokemon[] = _("Do what with the Helper?");
...
const u8 gText_NoPokemonForBattle[] = _("No Helpers for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a Helper.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} Helpers are needed.");
const u8 gText_PokemonCantBeSame[] = _("Helpers can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose Helpers or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose Helpers and confirm.");
const u8 gText_SendWhichMonToPC[] = _("Send which Helper to the PC?");
...
const u8 gText_PkmnCantParticipate[] = _("That Helper can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That Helper can't be traded\nnow.");
ALIGNED(4) const u8 gText_PkmnCantBeTraded[] = _("That Helper can't be traded.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's Helper\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of Helper\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL HELPER");
...
const u8 gText_PkmnInfo[] = _("HELPER INFO");
const u8 gText_PkmnSkills[] = _("HELPER SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("A Helper's egg found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A Helper's egg\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A Helper's Egg\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A Helper's egg that\nwas passed on to you.");
const u8 gText_EggFromTraveler[] = _("A Helper's Egg\nobtained from a traveler.");
...
const u8 gText_BagIsFull[] = _("The BINDLE is full.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailToBagMessageErased[] = _("The MAIL was returned to the BINDLE\nwith its message erased.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Poke_Balls[] = _("HEARTS");
const u8 gText_TMs_Hms[] = _("TMs & HMs");
const u8 gText_Berries2[] = _("BERRIES");
const u8 gText_SomeonesPC[] = _("Someone's PC");
const u8 gText_LanettesPC[] = _("Dedede's PC");
const u8 gText_BillsPc[] = _("BILL'S PC");
const u8 gText_PlayersPC[] = _("Kirby's PC");
...
const u8 gText_MenuOptionPokedex[] = _("CARDS");
const u8 gText_MenuOptionPokemon[] = _("HELPERS");
const u8 gText_MenuOptionBag[] = _("BINDLE");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the Helper MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the Helper MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("CASTLE DEDEDE");
const u8 gText_PokemonCenter[] = _("BREAK ROOM");
...
const u8 gText_TrainerCardPokedex[] = _("CARDS");
...
const u8 gText_PokemonTrades[] = _("HELPER TRADES");
...
const u8 gText_Pokemon2[] = _("HELPERS");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your Helper battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up Helpers!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental Helpers!\nYour knowledge will be tested.");
...
const u8 gText_PkmnJumpRecords[] = _("HELPER JUMP RECORDS");
...
const u8 gText_FrontierFacilityTotalCaughtSpeciesBanned[] = _(" and {STR_VAR_2} of the Helper species\nyou caught are inelegible");
...
const u8 gText_MenuPokedex[] = _("CARDS");
const u8 gText_MenuPokemon[] = _("HELPERS");
const u8 gText_MenuBag[] = _("BINDLE");
const u8 gText_MenuPokenav[] = _("POKéNAV");
const u8 gText_MenuPlayer[] = _("KIRBY");
...
const u8 gText_Hoenn[] = _("DREAM LAND");
const u8 gText_Kanto[] = _("POPSTAR");
...
const u8 gText_RentalPkmn2[] = _("RENTAL HELPER");
const u8 gText_SelectFirstPkmn[] = _("Select the first Helper.");
const u8 gText_SelectSecondPkmn[] = _("Select the second Helper.");
const u8 gText_SelectThirdPkmn[] = _("Select the third Helper.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three Helpers OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same Helper.");
const u8 gText_PkmnSwap[] = _("HELPER SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select Helpers to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select Helpers to accept.");
...
const u8 gText_PkmnForSwap[] = _("HELPER FOR SWAP");
const u8 gText_Cancel3[] = _("CANCEL");
const u8 gText_Swap2[] = _("SWAP"); // Unused
const u8 gText_Accept[] = _("ACCEPT"); // Unused
const u8 gText_AcceptThisPkmn[] = _("Accept this Helper?");
const u8 gText_4Spaces[] = _("    "); // Unused
const u8 gText_SamePkmnInPartyAlready[] = _("Same Helper in party already.");
const u8 gText_DecimalPoint[] = _(".");
const u8 gText_SavingPlayer[] = _("PLAYER");
const u8 gText_SavingBadges[] = _("BROOCHES");
const u8 gText_SavingPokedex[] = _("CARDS");
...
const u8 gText_PokeBalls[] = _("HEARTS");
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("OAK: It's important to get to know\nyour Helpers thoroughly.\p");
const u8 gText_OakThisIsListOfPokemon[] = _("This is a list of your Helpers,\nKirby.\pOpen this to check the skills\nand moves of your Helpers.\pYou also choose Helpers here if\nyou want to use an item on one.{PAUSE_UNTIL_PRESS}");
